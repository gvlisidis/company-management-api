            ...
            <DisclosurePanel class="md:hidden">
                ...
                <div class="pt-4 pb-3 border-t border-gray-700">
                    ...
                    <div class="mt-3 px-2 space-y-1">
                        <DisclosureButton as="a" @click="logout" class="block px-3 py-2 cursor-pointer rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Sign out</DisclosureButton>
                    </div>
                </div>
            </DisclosurePanel>
        </Disclosure>
...
export default {
    components: {
        MenuIcon, XIcon, Disclosure, DisclosureButton, DisclosurePanel, Menu, MenuButton, MenuItems, MenuItem
    },
    setup() {
